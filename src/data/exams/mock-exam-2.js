...
print(df["x"].min())`,
    ...
    },
    {
      ...
      answerIndex: 1,
      explanation: 'MVP chỉ gồm những tính năng cốt lõi.',
    },
    {
      id: 'e2c6',
      module: 'C',
      type: 'multiple-choice',
      topic: 'AI vs ML vs DL',
      question: 'Trong sơ đồ, thứ tự từ rộng đến hẹp đúng là?',
      options: ['ML ⊂ DL ⊂ AI', 'AI ⊂ ML ⊂ DL', 'DL ⊂ ML ⊂ AI', 'AI ⊂ DL ⊂ ML'],
      answerIndex: 2,
      explanation: 'DL là tập con của ML, ML là tập con của AI.',
    },
    {
      id: 'e2c7',
      module: 'C',
      type: 'multiple-choice',
      topic: 'Hồi quy tuyến tính',
      question: 'Hồi quy tuyến tính phù hợp cho bài toán nào?',
      options: ['Dự đoán giá nhà (số liên tục)', 'Phân loại thư rác', 'Gom cụm khách hàng', 'Nhận dạng ảnh'],
      answerIndex: 0,
      explanation: 'Hồi quy tuyến tính dùng cho dự đoán giá trị số liên tục.',
    },
    {
      id: 'e2c8',
      module: 'C',
    ...
    },
    {
      ...
      type: 'multiple-choice',
      topic: 'Hồi quy logistic',
      question: 'Hồi quy logistic thường dùng cho bài toán gì?',
      options: ['Dự đoán số liên tục', 'Phân loại nhị phân (2 lớp)', 'Gom cụm', 'Giảm chiều'],
      answerIndex: 1,
      explanation: 'Hồi quy logistic thường dùng cho phân loại nhị phân.',
    },
    {
      id: 'e2c14',
      module: 'C',
      type: 'multiple-choice',
      topic: 'Quy trình ML',
      question: 'Train/test split giúp phát hiện vấn đề gì?',
      options: ['Dữ liệu bẩn', 'Overfitting/underfitting', 'Mã lỗi', 'Tốc độ mạng'],
      answerIndex: 1,
      explanation: 'Split giúp đánh giá khả năng khái quát và phát hiện overfitting.',
    },
    {
      id: 'e2c15',
      module: 'C',
      type: 'multiple-choice',
      topic: 'MVP',
      question: 'Bước đầu tiên khi thiết kế một MVP là gì?',
